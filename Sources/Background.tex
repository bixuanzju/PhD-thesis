...
unique coercions, they also employ the notion of \textit{ordinary types}~\citep{Davies_2000} --- those which are not intersection types --- and
use the judgment ``$[[ A ord ]]$'' in \rref{s-andl, s-andr}. Ordinary types and
