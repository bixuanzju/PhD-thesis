...
\lstinputlisting[linerange=17-21]{./examples/overview2.sl}% APPLY:linerange=OVERVIEW_EDITOR
...
\lstinputlisting[linerange=10-11]{./examples/overview2.sl}% APPLY:linerange=OVERVIEW_EDITOR_TYPES
For the sake of conciseness, \name uses \lstinline{type} aliases to abbreviate types.

\paragraph{Self-Types Encode Abstract Methods.}
...
\lstinputlisting[linerange=25-32]{./examples/overview2.sl}% APPLY:linerange=OVERVIEW_HELP
...
\lstinputlisting[linerange=37-44]{./examples/overview2.sl}% APPLY:linerange=OVERVIEW_MODAL
...
a concrete editor:
\lstinputlisting[linerange=49-52]{./examples/overview2.sl}% APPLY:linerange=OVERVIEW_LINE
