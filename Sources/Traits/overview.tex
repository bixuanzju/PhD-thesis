...
\sedel uses a type system based on \emph{disjoint intersection types}~\citep{oliveira2016disjoint} and
\emph{disjoint polymorphism}~\citep{alpuimdisjoint}. Disjoint intersections
