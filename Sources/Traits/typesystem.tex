...
abstract methods, first-class traits, dynamic inheritance, etc.) to \fnamee. The
...
\sedel. The well-formedness rule (\rref{WF-trait}) for trait types is straightforward. The
...
implicitly assumes a $[[super]]$ variable pointing to the \lstinline{inherits}
