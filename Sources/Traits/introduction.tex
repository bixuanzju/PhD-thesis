...
\fname~\cite{alpuimdisjoint}, a polymorphic calculus with records supporting disjoint polymorphism.
...
%   construct}~\cite{dunfield2014elaborating}. In \sedel subtyping is modelled with
...
\item \textbf{Elaboration of first-class traits into disjoint intersection types/polymorphism:}
  ...
  \fname~\cite{alpuimdisjoint}. The elaboration is inspired by the
