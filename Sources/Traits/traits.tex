...
\lstinputlisting[linerange=112-115]{./examples/overview2.sl}% APPLY:linerange=HELP
...
\lstinputlisting[linerange=105-107]{./examples/overview2.sl}% APPLY:linerange=HELP3
...
\lstinputlisting[linerange=119-123]{./examples/overview2.sl}% APPLY:linerange=MODAL2
...
\lstinputlisting[linerange=133-137]{./examples/overview2.sl}% APPLY:linerange=MODAL_CONFLICT
...
is selected:
\lstinputlisting[linerange=144-150]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK
Now the above code type checks. We can also select \lstinline{on_key} in the \lstinline{spell} trait as easily:
\lstinputlisting[linerange=155-160]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK2
...
\lstinputlisting[linerange=164-169]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK3
...
\lstinputlisting[linerange=174-182]{./examples/overview2.sl}% APPLY:linerange=MODAL_WIRE
...
small test:
\lstinputlisting[linerange=186-189]{./examples/overview2.sl}% APPLY:linerange=MODAL_USE
