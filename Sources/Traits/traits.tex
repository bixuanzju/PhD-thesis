...
\paragraph{Traits as Templates for Creating Objects.} An obvious difference between
...
\lstinputlisting[linerange=67-67]{./examples/overview2.sl}% APPLY:linerange=EDITOR_INST
...
\lstinputlisting[linerange=90-93]{./examples/overview2.sl}% APPLY:linerange=HELP
...
% and \lstinline{help}.
% \lstinputlisting[linerange=78-79]{./examples/overview2.sl}% APPLY:linerange=HELP2
...
\lstinputlisting[linerange=97-101]{./examples/overview2.sl}% APPLY:linerange=MODAL2
...
\lstinputlisting[linerange=111-113]{./examples/overview2.sl}% APPLY:linerange=MODAL_CONFLICT
...
is selected:
\lstinputlisting[linerange=120-123]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK
Now the above code type checks. We can also select \lstinline{on_key} in the \lstinline{spell} trait as easily:
\lstinputlisting[linerange=128-131]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK2
...
\lstinputlisting[linerange=135-138]{./examples/overview2.sl}% APPLY:linerange=MODAL_OK3
...
\lstinputlisting[linerange=143-150]{./examples/overview2.sl}% APPLY:linerange=MODAL_WIRE
...
small test:
\lstinputlisting[linerange=154-156]{./examples/overview2.sl}% APPLY:linerange=MODAL_USE
