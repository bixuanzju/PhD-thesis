...
important difference is that their compatibility judgment $r_1 \# r_2$ effectively
...
limit expressiveness of types, most useful datatypes (e.g., natural numbers,
lists) are positive. Also the positivity restriction agrees with the
...
\[
  \drule{D-rec}
\]
We also need a few disjointness axioms:
\begin{mathpar}
  \drule{Dax-intRec}
  \drule{Dax-rcdRec}
  \drule{Dax-arrRec}
