...
merge operator that works on functions only.
...
\citet{pierce1991programming} studies $\mathsf{F}_{\land}$.


Recently, \citet{castagna2014polymorphic} studied a coherent calculus that has
...
\citet{alpuimdisjoint} studied \fname.
...
algorithm. Only recently, \citet{Laurent18b} presents two sequent-calculus
systems that are algorithmic and equivalent to BCD subtyping.
\todo{show the rules?}
Based on \citeauthor{Statman_2015}'s work~\citep{Statman_2015},
