...
$\forall$-quantifier behaves somewhat like a function space constructor,
...
\citet{alpuimdisjoint}, one important use of intersection types in TypeScript
...
Also as we pointed out in \cref{sec:merge},
