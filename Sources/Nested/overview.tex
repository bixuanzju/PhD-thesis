...
\lstinputlisting[linerange=17-22]{../../impl/examples/overview.sl}% APPLY:linerange=LANG_IMPL
...
\lstinputlisting[linerange=27-27]{../../impl/examples/overview.sl}% APPLY:linerange=EVAL_INTERFACE
The type for \lstinline{LangEval} is then:
\lstinputlisting[linerange=32-35]{../../impl/examples/overview.sl}% APPLY:linerange=EVAL_PRINT_INTERFACE
...
\lstinputlisting[linerange=43-49]{../../impl/examples/overview.sl}% APPLY:linerange=EVAL_PRINT_IMPL

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subparagraph{Adding Negation.}
Adding negation to \lstinline{Lang} works similarly.
\lstinputlisting[linerange=53-59]{../../impl/examples/overview.sl}% APPLY:linerange=LANG_NEG
...
\lstinputlisting[linerange=64-71]{../../impl/examples/overview.sl}% APPLY:linerange=LANG_FINAL
...
\lstinputlisting[linerange=89-91]{../../impl/examples/overview.sl}% APPLY:linerange=TEST
...
\lstinputlisting[linerange=39-39]{../../impl/examples/overview.sl}% APPLY:linerange=EVAL_INTERFACE2
