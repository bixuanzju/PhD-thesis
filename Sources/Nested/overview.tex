...
very similar to \citeauthor{Ernst_2001}'s gbeta solution in \cref{sec:ernst}.
...
of the non-disjoint type $\inter{\mathsf{Int}}{\mathsf{Int}}$ is entirely unambiguous, and
...
$ 1 : \inter{\mathsf{Int}}{\mathsf{Int}}$ creates the equivalent value implicitly.
...
for non-disjoint types. We shall return to this point in \cref{chap:coherence:simple}.
