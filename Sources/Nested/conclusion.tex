...
polymorphism~\citep{reynolds1983types}. % and we foresee no fundamental difficulties
...
% \lstinputlisting[linerange=86-87]{./examples/overview.sl}% APPLY:linerange=LANG_EXT_INTER
...
% \lstinputlisting[linerange=92-93]{./examples/overview.sl}% APPLY:linerange=LANG_EXT
