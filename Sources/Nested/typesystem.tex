...
The separate syntactic category for \textit{explicit coercions} is a distinct difference
...
\begin{lemma}[Coercions preserve types]   \label{lemma:sub-correct}
...
\begin{lemma}[Elaboration soundness] \label{thm:elab_safe}
  We have that:
  \begin{itemize}
