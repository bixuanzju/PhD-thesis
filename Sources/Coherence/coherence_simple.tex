...
in \cref{fig:logical} what we call the \textit{canonicity} relation to capture ``canonical''
values based on the above observations. The canonicity relation is a family of binary
