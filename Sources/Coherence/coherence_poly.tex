...
\cref{sec:para:lr}. We then talk about a failed attempt on a naturally extending
it to deal with disjoint intersection types in \cref{sec:failed:lr}. The technical
...
\begin{proof}
  ...
  induction the structures of $[[A]]$ and $[[B]]$.
\end{proof}
...
\fnamee and \tnamee, which are shown in \cref{fig:contexts:fi}. As with before,
the typing judgment of \fnamee contexts has 4 different forms:
\begin{mathpar}
